...
public interface People {
     ...
     */
    @WebMethod
    @WebResult(name = "meaureValue", targetNamespace = "")
     ...
     */
    @WebMethod
    @WebResult(name = "updateHistory", targetNamespace = "")
     ...
     */
    @WebMethod
    @WebResult(name = "updateMeasure", targetNamespace = "")
    ...
    public Person updatePersonMeasure(
        @WebParam(name = "personId", targetNamespace = "")
        int personId,
        @WebParam(name = "lifeStatus", targetNamespace = "")
        LifeStatus lifeStatus);
