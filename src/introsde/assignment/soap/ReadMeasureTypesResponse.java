 ...
 *       &lt;sequence>
 *         &lt;element name="measureTypes" type="{http://soap.assignment.introsde/}measureDefinition" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ReadMeasureTypesResponse {
    ...
    protected List<MeasureDefinition> measureTypes;
    ...
    public List<MeasureDefinition> getMeasureTypes() {
        if (measureTypes == null) {
            measureTypes = new ArrayList<MeasureDefinition>();
        }
